...
plot(estim.t$l, estim.t$estim, type = "l", main="Estimating the observation frequency",  #main= paste("Opt.intens =", as.numeric(estim.t[estim.t$estim==min(as.numeric(estim.t$estim)),]$l), ",  sigma^2 =", sigma.sq, sep=" "),
     ylab = "Functional value", xlab = "observation frequency", bty="n", lwd=5, col= "#1b9e77")
     #sub = paste("Figure 1. Estimating of observation frequency,\n","where optimal frequency is equal to", as.numeric(estim.t[estim.t$estim==min(as.numeric(estim.t$estim)),]$l),".", sep=" "))#"#4daf4a")#"#e31a1c") #"#f0027f")
...
# print("##############################")
# print("#### Estimating of optimal ###")
# print("### observations frequency ###")
# print("##############################")
# print(paste("Optimal frequency of observations is ", as.numeric(estim.t[estim.t$estim==min(as.numeric(estim.t$estim)),]$l), sep=" "))
# print("##############################")
